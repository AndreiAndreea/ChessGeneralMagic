...
TEST(PossibleMovesTest, ValidMovesPosibilitiesKnight5)
{
	...
	EXPECT_EQ(board.GetBoard()[3][7]->GetPossibleMoves(Position(3, 7), board), vector);
}
...
TEST(PossibleMovesTest, ValidMovesPosibilitiesKing)
{
	...
	auto vect1 = board.GetBoard()[3][7]->GetPossibleMoves(Position(3, 7), board);
	EXPECT_EQ(board.GetBoard()[3][7]->GetPossibleMoves(Position(3, 7), board), vector);
}
...

{
	...
	auto vect1 = board.GetBoard()[5][7]->GetPossibleMoves(Position(5, 7), board);
	EXPECT_EQ(board.GetBoard()[5][7]->GetPossibleMoves(Position(5, 7), board), vector);
}
...
TEST(PossibleMovesTest, ValidMovesPosibilitiesKing4)
{
	...
	auto vect1 = board.GetBoard()[0][4]->GetPossibleMoves(Position(0, 4), board);
	EXPECT_EQ(board.GetBoard()[0][4]->GetPossibleMoves(Position(0, 4), board), vector);
}
...
TEST(PossibleMovesTest, ValidMovesPosibilitiesKing3)
{
	...
	auto vect1 = board.GetBoard()[3][5]->GetPossibleMoves(Position(3, 5), board);
	//incorrect vect1 
	EXPECT_EQ(board.GetBoard()[3][5]->GetPossibleMoves(Position(3, 5), board), vector);
}
...
TEST(PossibleMovesTest, ValidMovesPosibilitiesQueen)
{
	...
	auto ceva = board.GetBoard()[5][1]->GetPossibleMoves(Position(5, 1), board);
